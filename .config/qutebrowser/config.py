...
# qutebrowser --temp-basedir -s window.transparent true

c.colors.statusbar.normal.bg = "rgba(253,0,85,238)"
c.colors.statusbar.command.bg = "rgba(98, 2, 252, 1)"

c.colors.statusbar.command.fg = "rgba(253,0,85,238)"
c.colors.statusbar.normal.fg = "rgba(253,0,85,238)"
# c.colors.statusbar.normal.bg = xresources["*.background"]
# c.colors.statusbar.command.bg = xresources["*.background"]
c.colors.statusbar.command.fg = "rgba(253,0,85,238)"
c.colors.statusbar.normal.fg = "white"
c.colors.statusbar.passthrough.fg = "white"
c.colors.statusbar.url.fg = "aqua"
...
c.colors.tabs.even.bg = "rgba(0,0,0,0)" # transparent tabs!!
...
c.colors.tabs.selected.even.bg = "rgba(253,0,85,238)"
c.colors.tabs.selected.odd.bg = "rgba(253,0,85,238)"
